...
const DashboardLayout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Accounting', href: '/accounting', icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z' },
    { name: 'Tax', href: '/tax', icon: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2zM10 8.5a.5.5 0 11-1 0 .5.5 0 011 0zm5 5a.5.5 0 11-1 0 .5.5 0 011 0z' },
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className={`fixed inset-0 z-40 lg:hidden ${mobileMenuOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex max-w-xs w-full flex-col bg-white">
          <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200">
            <div className="flex items-center">
              <span className="text-xl font-bold text-primary-600">MOKMzansiBooks</span>
            </div>
            <button
              type="button"
            ...
            <nav className="px-2 py-4 space-y-1">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
                  className="group flex items-center px-2 py-2 text-base font-medium rounded-md hover:bg-gray-50 hover:text-primary-600"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <svg
                    className="mr-4 h-6 w-6 text-gray-500 group-hover:text-primary-600"
            ...
            <nav className="flex-1 px-2 space-y-1">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
                  className="group flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-gray-50 hover:text-primary-600"
                >
                  <svg
            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="hidden lg:flex lg:items-center lg:ml-6">
                  <span className="text-gray-900 font-medium">Welcome to MOKMzansiBooks</span>
                </div>
              </div>
              <div className="flex items-center">
